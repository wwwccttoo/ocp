...
@registry.register_model("equiformer_v2_plasma")
...
def radius_graph_pbc_plasma(
    ...
    mask_no_offsets = (pbc_offsets_per_atom == 0.0).all(dim=1).view(-1)
    mask_with_proton = mask_with_proton & mask_no_offsets
