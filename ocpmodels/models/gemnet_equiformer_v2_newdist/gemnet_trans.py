...
@registry.register_model("gemnet_trans_newdist")
class GemNetTrans(BaseModel):
    """
    GemNet, triplets-only variant of GemNet, compensating for system/method mismatches
    ...
    def forward(self, data):
        ...
        for i in range(self.num_blocks):
            ...
            # TODO: not adding F to F_st really correct???
            # (nAtoms, num_targets), (nEdges, num_targets)
            E_all.append(E)
            F_all.append(F)
