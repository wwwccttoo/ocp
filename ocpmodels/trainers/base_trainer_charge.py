"""
Special data base trainer for plasma-catalysis data
...
@registry.register_trainer("base_charge")
class BaseTrainerCharge(ABC):
    @property
    ...
    def load_datasets(self):
        self.parallel_collater = ParallelPlasmaCollater(
